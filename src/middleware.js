...
export default auth((req) => {
  ...
  if (req.auth && (req.nextUrl.pathname === "/patient/auth/login" || req.nextUrl.pathname === "/patient/auth/signup" || req.nextUrl.pathname === "/doctor/auth/login" || req.nextUrl.pathname === "/")) {
